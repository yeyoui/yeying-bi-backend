...
public class LogInterceptor {
    ...
    private static final Set<String> excludeUrlSet = new HashSet<>();
    static {
        ...
        excludeUrlSet.add("/api/payment/paymentResult");
    }

    /**
     * 执行拦截
     */
    @Around("execution(* com.yeyou.yeyingBIbackend.controller.*.*(..))")
    public Object doInterceptor(ProceedingJoinPoint point) throws Throwable {
        ...
        if(!excludeUrlSet.contains(url)){
            userService.getLoginUser(NetUtils.getHttpServletRequest());
        }
        // 执行原方法
