...
public class UserInterfaceInfoController {
    ...
    public BaseResponse<Long> addUserInterfaceInfo(@RequestBody OrderRecordAddRequest userInterfaceInfoAddRequest, HttpServletRequest request) {
    ...
    @PostMapping("/update")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> updateUserInterfaceInfo(@RequestBody OrderRecordUpdateRequest userInterfaceInfoUpdateRequest,
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    @GetMapping("/list")
    public BaseResponse<List<UserInterfaceInfo>> listUserInterfaceInfo(OrderRecordQueryRequest userInterfaceInfoQueryRequest) {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Page<UserInterfaceInfo>> listUserInterfaceInfoByPage(OrderRecordQueryRequest userInterfaceInfoQueryRequest, HttpServletRequest request) {
        if (userInterfaceInfoQueryRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        UserInterfaceInfo userInterfaceInfoQuery = new UserInterfaceInfo();
